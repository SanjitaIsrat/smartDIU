...
const TeacherSidebar = ({showSidebar }) => {
  ...
  {showSidebar && ( 
    <div className="h-screen fixed bg-emerald-100 text-emerald-600 font-semibold  w-2/12  flex flex-col py-20 px-1  top-0">
      ...
      <Link className="hover:bg-emerald-600 hover:text-white flex items-center gap-2 py-2 px-3" to="/update/avatar">
        Update Avatar
      </Link>
      <Link className="hover:bg-emerald-600 hover:text-white flex items-center gap-2 py-2 px-3" to="/update/profile">
        Update Profile
      </Link>
      <Link className="hover:bg-emerald-600 hover:text-white flex items-center gap-2 py-2 px-3" to="/update/password">
        Update Password
      </Link>
